...
authors: "Surya Gupta, Tom Hengl, Peter Lehmann, Sara Bonetti, Andreas Papritz, Dani Or"
date: "Surya Gupta, Tom Hengl, Peter Lehmann, Sara Bonetti, Andreas Papritz, Dani Or"
...
I.vars = make.names(unique(unlist(sapply(c("s.no","clm_", "dtm_", "lcv", "veg_", "olm_c", "olm_s", "olm_bd","DEPTH"), function(i){names(dfs)[grep(i, names(dfs))]}))))
...
hexbinplot(log_ksat1~ prediction1, 
           ...
           data = dd,xlab = "Predicted Ksat [cm/day]", ylab = "Measured Ksat [cm/day]",cex.axis = 4, aspect="1", xbins=80, colramp = function(n) {viridis (8,  alpha = 1, begin = 0, end = 1, direction = -1,option = "C")},xlim=c(0.1,10000), ylim=c(0.1,10000),
           scales=list(
